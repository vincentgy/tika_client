...
class ReactNativeModal extends Component {
  ...
  open = () => {
    ...
    if(this.body){
      this.body[this.animationIn](this.props.animationInTiming).then();
    }
  ...
  _close = () => {
    ...
    if(this.body){
      this.body[this.animationOut](this.props.animationOutTiming).then()
    }
  ...
  render() {
    ...
    const containerView = (
      ...
      <View style={{height:50,backgroundColor:'blue'}}  />
       ...
       <View  ref={(body)=>this.body = body}  style={[panPosition, computedStyle]} >
       {_children}
       </View>
       </React.Fragment>
    );
